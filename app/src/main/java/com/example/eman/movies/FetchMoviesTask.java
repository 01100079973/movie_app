...
public class FetchMoviesTask extends AsyncTask<String, Void, Movie[]> {
    ...
    private ImageAdapter.ImageGridAdapter mMovieAdapter;

    public FetchMoviesTask(Context context,  ImageAdapter.ImageGridAdapter imageGridAdapter) {
        mContext = context;
    ...
    protected Movie[] doInBackground(String... params) {
        ...
        //insert your API key
        final String API_KEY = "e7e127ce58d6e5ef9e38753de0303e5f"; // i write
